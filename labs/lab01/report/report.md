...
Установил другой вариант консоли (см. [рис.13](#fig-013)).

![Установка другого варианта консоли](image/13.png){#fig-013 width=70%}

Установил автоматическое обновление и запустил таймер (см. [рис.14](#fig-014)).

![Установка автоматического обновления и запуск таймера](image/14.png){#fig-014 width=70%}

Отключил систему безопасности SELinux (см. [рис.15](#fig-015)).

![Установка автоматического обновления и запуск таймера](image/15.png){#fig-015 width=70%}

Запустил терминальный мультиплексор tmux и создал конфигурационный файл `~/.config/sway/config.d/95-system-keyboard-config.conf` (см. [рис.16](#fig-016)).

![Запуск терминального мультиплексора tmux и создание конфигурационного файла](image/16.png){#fig-016 width=70%}

Отредактировал конфигурационный файл `~/.config/sway/config.d/95-system-keyboard-config.conf` (см. [рис.17](#fig-017)).

![Отредактированный конфигурационный файл](image/17.png){#fig-017 width=70%}

Переключился на роль супер-пользователя и открыл конфигурационный файл (см. [рис.18](#fig-018)).

![Переключение на роль супер-пользователя и открытие конфигурационного файла](image/18.png){#fig-018 width=70%}

Отредактировал конфигурационный файл (см. [рис.19](#fig-019)).
